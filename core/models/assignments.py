...
class Assignment(db.Model):
    ...
    def submit(cls, _id, teacher_id, principal: Principal):
        ...
        return assignment
    @classmethod
    def grading(cls, _id, teacher_id,grade,principal: Principal):
        assignment = Assignment.get_by_id(_id)
        
        assertions.assert_found(assignment, 'No assignment with this id was found')
        assertions.assert_valid(assignment.teacher_id == principal.teacher_id, 'This assignment belongs to some other teacher')
        assertions.assert_valid(assignment.state==AssignmentStateEnum.SUBMITTED, 'assignment is not yet submitted')
        assertions.assert_valid(grade=='A' or grade=='B' or grade=='C' or grade=='D', 'Invalid grade please A,B,C,D.')
